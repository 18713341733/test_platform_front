            ...
            getTestcaseDetail(){
                get_detail_testcase(this.current_testcase_id)
                    .then(response => {
                        ...
                        this.testcase_name = response.testcase_name;
                        this.selected_project_id = response.selected_project_id;
                        this.getInterfacesByProjectID(this.selected_project_id);
                        this.selected_interface_id = response.selected_interface_id;
                        this.getConfTestcaseByInterfaceID(this.selected_interface_id);
                        this.selected_configure_id = response.selected_configure_id;
                        this.selected_testcase_id = response.selected_testcase_id;

                        this.apiMsgData.method = response.method;
                        this.apiMsgData.url = response.url;
                        this.apiMsgData.param = response.param;
                        this.apiMsgData.header = response.header;
                        this.apiMsgData.variable = response.variable;

                        this.apiMsgData.jsonVariable = response.jsonVariable;
                        if (this.apiMsgData.jsonVariable === 'null') {
                            this.apiMsgData.choiceType = 'data';
                        }
                        this.apiMsgData.extract = response.extract;
                        this.apiMsgData.validate = response.validate;
                        this.apiMsgData.globalVar = response.globalVar;
                        this.apiMsgData.parameterized = response.parameterized;
                        this.apiMsgData.setupHooks = response.setupHooks;
                        this.apiMsgData.teardownHooks = response.teardownHooks;
...
<style scoped>
    ...
    .el-input-group__append .el-select, .el-input-group__prepend .el-select {
      margin: 0;
    }
</style>
