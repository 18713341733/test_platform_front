...
<script>
    import { report_view } from '../../apitestapi/api';
    export default {
            ...
            getData() {
                report_view(this.report_id)
                    .then(response => {
                        ...
                        this.html_report_name = response.summary.html_report_name;
                        // console.log(response.data);
                        // console.log(response.data.summary.time);
                        this.time = response.summary.time;
                        this.stat = response.summary.stat;
                        this.platform = response.summary.platform;
                        this.details = response.summary.details;
                    })
                    .catch(error => {
