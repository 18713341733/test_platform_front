...
<script>
    import { interfaces_list, delete_interface, edit_interface, envs_names, run_by_interface } from '../../apitestapi/api';
        ...
        methods: {
            ...
            getData() {
                ...
                .then(response => {
                    ...
                    this.cur_page = response.data.page || 1;
                    this.total_nums = response.data.total || 1;
