        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                    ...
                    <el-form-item label="请求url" prop="base_url" required>
...
<script>
    import { add_env, envs_names } from '../../apitestapi/api';
        ...
        data: function(){
            let validateName = (rule, value, callback) => {
                ...
                if(len <= 0){
                    ...
                    for (let index = 0; index < this.env_names && this.env_names.length ; index++) {
